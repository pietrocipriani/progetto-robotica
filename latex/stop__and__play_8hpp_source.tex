...
\DoxyCodeLine{00054\ \ \ chain.emplace\_back(std::move(q1),\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_adfdcbaf78892a0d45a6eb99bf478cab4}{start}});}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \textcolor{keywordflow}{if}\ (t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a6395dcc37b097aa39004184b005870d4}{start\_linear}}\ <\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a7294a3236374086519a982f176c3ff21}{end\_linear}})\ \{}
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keyword}{auto}\ l\ =\ \mbox{\hyperlink{namespaceplanner_ad63228565ee5abe7bb79e6506de8752d}{linear\_interpolation}}(start.\mbox{\hyperlink{structplanner_1_1Params_afa95e3c7f6220a97484f80f2726b5eb5}{point}},\ end.\mbox{\hyperlink{structplanner_1_1Params_afa95e3c7f6220a97484f80f2726b5eb5}{point}},\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_adfdcbaf78892a0d45a6eb99bf478cab4}{start}}\ +\ start.\mbox{\hyperlink{structplanner_1_1Params_a600304b2d788c2da3302409944aab823}{times}}.\mbox{\hyperlink{structplanner_1_1Params_1_1Times_a05ec4283e270826f28435bc4a83f7fd8}{accel\_delta}}\ /\ 2,\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a94ea76065c124cb9dbd679bf2a4d11c3}{delta}});}
\DoxyCodeLine{00058\ \ \ \ \ chain.emplace\_back(std::move(l),\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a6395dcc37b097aa39004184b005870d4}{start\_linear}});}
\DoxyCodeLine{00059\ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00060\ \ \ \ \ assert(t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a6395dcc37b097aa39004184b005870d4}{start\_linear}}\ -\/\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a7294a3236374086519a982f176c3ff21}{end\_linear}}\ <\ \mbox{\hyperlink{constants_8hpp_a3f94be92fb4585716d5e50a9bf57d887}{dummy\_precision}});}
\DoxyCodeLine{00061\ \ \ \}}
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \ \ \textcolor{keyword}{auto}\ q2\ =\ \mbox{\hyperlink{namespaceplanner_ae82fe1dba0d85fc6ad3ea48c220e03a3}{quadratic\_deceleration}}(end.\mbox{\hyperlink{structplanner_1_1Params_afa95e3c7f6220a97484f80f2726b5eb5}{point}},\ v,\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_ae22a8bbd631ba35d5e07d97f1453dc59}{end}},\ end.\mbox{\hyperlink{structplanner_1_1Params_a600304b2d788c2da3302409944aab823}{times}}.\mbox{\hyperlink{structplanner_1_1Params_1_1Times_a05ec4283e270826f28435bc4a83f7fd8}{accel\_delta}});}
\DoxyCodeLine{00064\ \ \ chain.emplace\_back(std::move(q2),\ t.\mbox{\hyperlink{structplanner_1_1internal_1_1Timestamps_a7294a3236374086519a982f176c3ff21}{end\_linear}});}
\DoxyCodeLine{00065\ \}}
\DoxyCodeLine{00066\ }
\DoxyCodeLine{00067\ \}}
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00076\ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ Po\textcolor{keywordtype}{int},\ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ T>\ \textcolor{keyword}{class\ }Container\ =\ std::initializer\_list>}
\DoxyCodeLine{00077\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespaceplanner_a38449017270e77826b9b2e6298be936b}{stop\_and\_play\_interpolation}}(}
\DoxyCodeLine{00078\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{structplanner_1_1Params}{Params<Point>}}\&\ start,}
\DoxyCodeLine{00079\ \ \ \textcolor{keyword}{const}\ Container<\mbox{\hyperlink{structplanner_1_1Params}{Params<Point>}}>\&\ points}
\DoxyCodeLine{00080\ )\ \{}
\DoxyCodeLine{00081\ \ \ \textcolor{keyword}{using\ namespace\ }internal;}
\DoxyCodeLine{00082\ \ \ \textcolor{keyword}{using\ }Sequence\ =\ \mbox{\hyperlink{classSequencedFunction}{SequencedFunction<TimeFunction<Point>}},\ \mbox{\hyperlink{types_8hpp_a3b5ed892af78b76780e76e03356804d7}{Time}}>;}
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00084\ \ \ \textcolor{comment}{//\ The\ resulting\ function\ is\ a\ chain\ of\ interpolations.}}
\DoxyCodeLine{00085\ \ \ \textcolor{keyword}{typename}\ Sequence::Container\ chain;}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ \textcolor{comment}{//\ points.size()\ -\/\ 1\ segments.}}
\DoxyCodeLine{00089\ \ \ \textcolor{comment}{//\ For\ each\ segment\ 3\ functions\ are\ needed\ (acc\ +\ lin\ +\ dec).}}
\DoxyCodeLine{00090\ \ \ chain.reserve(3\ *\ (points.size()\ -\/\ 1));}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ }
\DoxyCodeLine{00093\ \ \ \textcolor{keywordflow}{if}\ (points.size()\ ==\ 0)\ \{}
\DoxyCodeLine{00094\ \ \ \ \ \textcolor{comment}{//\ Constant\ function\ in\ case\ of\ only\ one\ point.}}
\DoxyCodeLine{00095\ \ \ \ \ chain.emplace\_back([p\ =\ start.\mbox{\hyperlink{structplanner_1_1Params_afa95e3c7f6220a97484f80f2726b5eb5}{point}}]([[maybe\_unused]]\ \textcolor{keyword}{const}\ \mbox{\hyperlink{types_8hpp_a3b5ed892af78b76780e76e03356804d7}{Time}}\&\ \_)\ \{return\ p;\},\ start.\mbox{\hyperlink{structplanner_1_1Params_a600304b2d788c2da3302409944aab823}{times}}.\mbox{\hyperlink{structplanner_1_1Params_1_1Times_ada213df0f23833509981179817b7beab}{time}});}
\DoxyCodeLine{00096\ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00097\ \ \ \ \ \textcolor{comment}{//\ This\ is\ a\ valid\ iterator\ as\ points.size()\ >=\ 1.}}
\DoxyCodeLine{00098\ \ \ \ \ \textcolor{keyword}{auto}\ i1\ =\ points.begin();}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \ \ interpolation2(start,\ *i1,\ chain);}
\DoxyCodeLine{00101\ \ \ \ \ \textcolor{keywordflow}{for}\ (;\ std::next(i1)\ !=\ points.end();\ i1\ =\ std::next(i1))\ \{}
\DoxyCodeLine{00102\ \ \ \ \ \ \ interpolation2(*i1,\ *std::next(i1),\ chain);}
\DoxyCodeLine{00103\ \ \ \ \ \}}
\DoxyCodeLine{00104\ \ \ \}}
\DoxyCodeLine{00105\ }
\DoxyCodeLine{00106\ \ \ \textcolor{keyword}{auto}\ s\ =\ Sequence(std::move(chain));}
\DoxyCodeLine{00107\ }
...
\DoxyCodeLine{00114\ }
\DoxyCodeLine{00115\ }
\DoxyCodeLine{00116\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ STOP\_AND\_PLAY\_HPP\_INCLUDED\ */}\textcolor{preprocessor}{}}
