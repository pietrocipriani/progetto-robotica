...
\Hypertarget{namespacecontroller_1_1control_a9840c6a68653591839cd36b873b5c3c5}\label{namespacecontroller_1_1control_a9840c6a68653591839cd36b873b5c3c5} 
\index{controller::control@{controller::control}!ensure\_valid\_initial\_config@{ensure\_valid\_initial\_config}}
\index{ensure\_valid\_initial\_config@{ensure\_valid\_initial\_config}!controller::control@{controller::control}}
\doxysubsubsection{\texorpdfstring{ensure\_valid\_initial\_config()}{ensure\_valid\_initial\_config()}}
{\footnotesize\ttfamily void ensure\+\_\+valid\+\_\+initial\+\_\+config (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcontroller_1_1control_1_1ConfigPublisher}{control\+::\+Config\+Publisher}} \&}]{config\+\_\+publisher,  }\item[{\mbox{\hyperlink{structmodel_1_1UR5_a1c5bc96710101e0c2c8259b7fa4a2ec6}{model\+::\+UR5\+::\+Configuration}} \&}]{configuration,  }\item[{double}]{prev\+\_\+gripper\+\_\+pos }\end{DoxyParamCaption})}



Makes sure that the theta6 parameter is in range (-\/pi, pi), which is a requirement for planner we use. 

In particular, moves the sixth joint linearly to position 0.\+0, so that it\textquotesingle{}s in the middle and the configuration will be surely valid.


\begin{DoxyParams}{Parameters}
{\em config\+\_\+publisher} & where to publish robot joint configurations so that they are performed in the simulation \\
\hline
{\em configuration} & the current joints config stored inside, before the robot has been initialized; will be changes to ensure valid initialization \\
\hline
{\em prev\+\_\+gripper\+\_\+pos} & the current gripper position, will not be changed \\
\hline
\end{DoxyParams}
